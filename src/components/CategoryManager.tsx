...
export function CategoryManager() {
  ...
  const saveCategory = () => {
    if (!newCategory.name || !newCategory.keywords?.length) return;
    ...
    <div className="p-4 bg-secondary rounded-lg">
      ...
      <div className="space-y-4 mb-6">
        {categories.map(category => (
          <div key={category.id} className="p-3 bg-primary rounded border border-border">
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={!newCategory.name || !newCategory.keywords?.length}
